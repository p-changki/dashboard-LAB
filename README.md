...
2. Download the latest macOS build asset such as `dashboard-LAB-0.1.13-arm64.dmg` or `dashboard-LAB-0.1.13-arm64-mac.zip`
...
1. Open [Releases](https://github.com/p-changki/dashboard-LAB/releases).
2. Download a macOS build asset such as `dashboard-LAB-0.1.13-arm64.dmg`.
