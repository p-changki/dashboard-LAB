...
import { CategoryFilter } from "@/components/file-manager/CategoryFilter";
import { AutoOrganize } from "@/components/file-manager/AutoOrganize";
import { FileManagerStats } from "@/components/file-manager/FileManagerStats";
import { SuggestionGroup } from "@/components/file-manager/SuggestionGroup";
import type {
  CleanupUrgency,
  FileCategory,
  FileCleanupAction,
