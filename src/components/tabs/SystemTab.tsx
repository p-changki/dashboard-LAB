...
import { DevPorts } from "@/components/system/DevPorts";
...
const AppLauncher = dynamic(
  () => import("@/components/system/AppLauncher").then((module) => module.AppLauncher),
  {
    ssr: false,
...
const FileActions = dynamic(
  () => import("@/components/system/FileActions").then((module) => module.FileActions),
  {
    ssr: false,
...
const FileActionResultPanel = dynamic(
  () => import("@/components/system/FileActions").then((module) => module.FileActionResultPanel),
  {
    ssr: false,
  },
);
...
const ProcessTable = dynamic(
  () => import("@/components/system/ProcessTable").then((module) => module.ProcessTable),
  {
    ssr: false,
