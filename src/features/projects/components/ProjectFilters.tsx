  ...
  return (
    <div className="panel grid gap-3 p-4 md:grid-cols-[1.6fr_1fr_1fr]">
      <Input
        ...
        placeholder="프로젝트 검색"
        className="rounded-2xl bg-white/6 placeholder:text-white/35"
      />
      <select
        value={typeFilter}
        onChange={(event) =>
        ...
        className="rounded-2xl border border-border-base bg-white/6 px-4 py-3 text-sm text-white outline-none"
      >
