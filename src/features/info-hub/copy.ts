  ...
  return pickLocale(locale, {
    ko: {
      ...
      autoRefresh: {
        ...
        standardDescription: "기본은 하루 1회 자동 갱신입니다.",
        realtimeDescription: "앱이 열려 있으면 1시간마다 강제 갱신하고 Signal Writer까지 함께 데웁니다.",
      ...
      trendingDescription: "GitHub Trending과 npm 흐름을 열었을 때만 가져옵니다.",
      ...
      securityTitle: "보안 알림",
      securityDescription: "프로젝트별 취약점 요약은 열었을 때만 가져옵니다.",
      loadingSection: "섹션 정보를 불러오는 중입니다.",
      emptySection: "표시할 항목이 없습니다.",
      sectionLoadFailed: "섹션 정보를 불러오지 못했습니다.",
      bookmarked: "북마크됨",
      bookmark: "북마크",
      signalWriterPick: "글감 담기",
      signalWriterPicked: "글감 담김",
      openOriginal: "원문 보기",
      translateLink: "번역 링크",
      source: "소스",
      scrape: "크롤링",
    ...
    en: {
      ...
      autoRefresh: {
        ...
        standardDescription: "The default behavior auto-refreshes once per day.",
        realtimeDescription: "While the app stays open, force-refresh every hour and warm Signal Writer in the background.",
      ...
      trendingTitle: "Live trends",
      trendingDescription: "Fetch GitHub Trending and npm trend snapshots only when this section is opened.",
      ...
      securityDescription: "Load project vulnerability summaries only when this section is opened.",
      loadingSection: "Loading section data...",
      emptySection: "Nothing to show here yet.",
      sectionLoadFailed: "Failed to load this section.",
      bookmarked: "Bookmarked",
      bookmark: "Bookmark",
      signalWriterPick: "Save for Writer",
      signalWriterPicked: "Saved for Writer",
